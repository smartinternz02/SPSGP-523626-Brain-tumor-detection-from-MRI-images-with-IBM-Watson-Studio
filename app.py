...
app = Flask(__name__)
model = load_model(r"C:\Users\RITIKA\Downloads\AI Smartinternz Project\SI-GuidedProject-4596-1626951146-main\SI-GuidedProject-4596-1626951146-main\Brain_Tumor.h5")
